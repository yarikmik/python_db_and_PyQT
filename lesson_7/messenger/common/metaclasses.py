...
class ServerMaker(type):
    def __init__(cls, clsname, bases, clsdict):
        ...
        # {'__module__': '__main__', '__qualname__': 'ServerSocket',
        # 'listen_port': < descriptors.Port object at 0x0000025498E47070 >,
        # '__init__': < function LogClass.__call__. < locals >.wrap at 0x0000025498E5C040 >,
        # 'transport': < socket.socket fd = 924, family = AddressFamily.AF_INET, type = SocketKind.SOCK_STREAM, proto = 0 >,
        # 'print_server_params': < function ServerSocket.print_server_params at 0x0000025498E5C160 >,
        # 'server_init': < function LogClass.__call__. < locals >.wrap at 0x0000025498E5C280 >}
